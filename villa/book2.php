...
<div class="container">
  ...
  <center><h3 style="color:   #B0C4DE">Deluxe Double Room  2 twin beds</h3></center>
...
$sql = "SELECT  id From rooms where checkRoom ='Available' AND  type = 'b' ORDER BY ID  DESC   LIMIT 1";
